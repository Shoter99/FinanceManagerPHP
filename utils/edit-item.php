...
<form class="p-3 card mt-3" action="/utils/update-item.php" method="POST">
    ...
    <div class="mb-3">
        ...
        <input value="<?php echo $item["price"] ?>" class="form-control" type="number" step="0.01" id="price"
            name="price" required>
    </div>
    <div class="mb-3">
    ...
    <input class="btn btn-primary" name="submit" type="submit" value="Update item">
